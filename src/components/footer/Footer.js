...
export default function Footer() {
    return(
        <>
            <footer className="w3-container w3-padding-32 w3-dark-grey">
                <div className="w3-row-padding">
                    <div className="w3-third">
                        ...
                        <p>Powered by <a href="#footer" target="_blank">w3.css</a></p>
                    </div>
                    ...
                    <div className="w3-third">
                        ...
                        <ul className="w3-ul w3-hoverable">
                            <li className="w3-padding-16">
                                <img src={logo} className="w3-left w3-margin-right" style={{width:"50px"}} alt=""/>
            ...
            <a href="#footer" title="W3.CSS" target="_blank" class="w3-hover-opacity">Andrey D</a></div>
        </>
    );
}