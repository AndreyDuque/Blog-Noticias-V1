    ...
    return (
        <>
            ...
            <div className="w3-container">
                <a href="#inicio" onclick="w3_close()" className="w3-hide-large w3-right w3-jumbo w3-padding w3-hover-grey" title="close menu">
                    <i className="fa fa-remove"></i>
                </a>
                <img src={logo} style={{width:"45%"}} className="w3-round" alt=""/><br/><br/>
                    <h4><b>PORTFOLIO</b></h4>
